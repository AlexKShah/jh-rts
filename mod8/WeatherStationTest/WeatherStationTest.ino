 ...
 * WIFI Settings
 **************************/
const char* WIFI_SSID = "ShahRedux";
const char* WIFI_PWD = "shahinternet11";
...
const char *api_key ="UQ8GSHQ7584O539E";                  //Your own thingspeak api_key
...
String OPEN_WEATHER_MAP_APP_ID = "6e7eea80c5b42efb37eee1708f8924a0";
String OPEN_WEATHER_MAP_LOCATION = "Poughkeepsie,NY,US";
...
void uploadTemperatureHumidity(){
  ...
  client.print(String("GET ") + "/update?api_key="+api_key+"&field1="+temp+"&field2="+humi +" HTTP/1.1\r\n" +"Host: " + host + "\r\n" + "Connection: close\r\n\r\n");
